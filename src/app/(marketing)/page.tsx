...
const appDemoImage = PlaceHolderImages.find((img) => img.id === 'app-demo-new');
        ...
        <div className="container px-4 md:px-6">
          <AnimatedSection className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                  ...
                  <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                      Explore our intuitive dashboard, designed to give you a clear view of your business at a glance. Track proposals, manage customers, and access powerful AI tools from one central hub.
                  </p>
              </div>
          </AnimatedSection>
          <AnimatedSection className="mt-12" delay={100}>
              <div className="relative mx-auto max-w-6xl rounded-xl bg-gray-900 shadow-2xl transition-transform duration-500 hover:scale-105">
                  <div className="flex h-11 items-center justify-start space-x-2 rounded-t-xl bg-gray-700 px-4">
                  ...
                  <div className="relative aspect-video overflow-hidden rounded-b-xl">
                      {appDemoImage && (
                          <Image
                              src={appDemoImage.imageUrl}
                              alt={appDemoImage.description}
                              fill
                              className="object-cover object-top"
                              data-ai-hint={appDemoImage.imageHint}
                          />
                      )}
                  </div>
              </div>
